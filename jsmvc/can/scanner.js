...
define([
    ...
    can.view.pending = function (viewData) {
        ...
        return can.view.hook(function (el) {
			...
			/* MaTHsPAcE haCK: Use non-legacy Mustache templates, so that can.Component
			 * attributes can be set directly in a Mustache template. */
			viewData.templateType = "mustache";
			/* END HACK */
            if (viewData.tagName) {
