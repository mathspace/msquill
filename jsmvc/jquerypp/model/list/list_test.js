define(['jquerypp/model/list/list', 'qunit', 'can/util/fixture'], function(){
...
test("push", function(){
	// Test push a model list into a model list
	var listOfPeople = new Person.List();
	listOfPeople.push(new Person({ name: "Barry" }));
	listOfPeople.push(new Person({ name: "Colin" }));

	equals(this.people.length, 20);
	this.people.push(listOfPeople);
	equals(this.people.length, 22);
});
